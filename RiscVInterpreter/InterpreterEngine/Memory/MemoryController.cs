...
{
    public Dictionary<string, int> integerRegisterNames = new()
    {
        { "x0 ",  0  }, { "zero", 0  },
        { "x1 ",  1  }, { "ra",   1  },
        { "x2 ",  2  }, { "sp",   2  },
    ...
    public Dictionary<string, int> floatRegisterNames = new()
    {
        { "f0 ",  0  }, { "ft0",  0  },
        { "f1 ",  1  }, { "ft1",  1  },
        { "f2 ",  2  }, { "ft2",  2  },
    ...
    public Memory MemoryStuff { get; private set; } = new Memory(256);
